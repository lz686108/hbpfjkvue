  ...
  methods: {
    ...
    echarts_list() {
      ...
      option = {
        ...
        xAxis: {
          type: "category",
          data: ["9:18", "9:28", "9:38", "9:48", "9:58","10:08","10:18","10:28","10:38"],
          axisTick: {
            show: false, //去掉刻度线
          },
          axisLine: {
        ...
        series: [
          ...
          {
            data: [270, 210, 260, 220, 200, 50, 280, 100, 100],
            type: "line",
            itemStyle: {
              normal: {
                color: 'red'
          ...
          {
            data: [250, 250, 250, 250, 250, 250, 250, 250, 250],
            type: "line",
            itemStyle: {
              normal: {
                color: '#69DBFC'
          ...
          {
            data: [100, 100, 340, 350, 380, 230, 130, 160, 280],
            type: "bar",
            itemStyle: {
              normal: {
                color: '#90FEB3'
          ...
          {
            data: [210, 210, 240, 250, 280, 100, 100, 340, 350],
            type: "bar",
            itemStyle: {
              normal: {
                color: '#4B99FF'
